...
<ul class="nav nav-list">
  ...
  <li><a href="/user/settings.php?username=<?php echo $user; ?>"><i class="icon-edit"></i> Account Settings</a></li>
  <li><a href="/user/messages.php?username=<?php echo $user; ?>"><i class="icon-envelope"></i> Messages</a></li>
